...
client.on('ready',  () => {
  console.log('by : ! ♕ l 𝒜ℳℰℰℛ_ ツ#3864');
});
...
client.on('message', message => {
  ...
  ❖ **!clear [عدد الرسائل] ** ==>** لمسح كل رسائل الشات**
  ❖ **!ban ** ==>** اعطاء باند لشخص **
  ❖ **!mute ** ==> اعطاء شخص ميوت يجعله لا يتكلم **
  ❖ **!unmute ** ==> ازالة الميوت عن شخص يجعله يتكلم**
  ❖ **!bans ** ==>** عرض كم شخص تم حضره من السيرفر**
  ❖ **!unmutechat ** ==>** يفتح الشات**
  ❖ **!mutechat ** ==>**يسكر الشات**
  ❖ **!setcolor ** ==>** يصنع لك 200 لون**
  ❖ **!dr ** ==>** حذف جميع الرومات**
  ❖  **!dc ** ==>** حذف جميع الرتب و الالوان**
  ❖ **!setmember ** ==>** يصنع لك روم يضهر كم شخص في السيرفر**
  ❖ **!settime** ==>** يصنع لك روم يضهر كم الساعة**
  ❖ **!setdate** ==>** يصنع لك روم يضهر لك التاريخ**
  ❖ **!textroom [name]** ==>** يصنع لك روم كتابي**
  ❖ **!voiceroom [name]** ==>** يصنع لك روم صوتي**
  ❖ **!close** ==>** حذف التذكرة**
  ...
  ❖ **!date ** ==>** لعرض التاريخ**
  ❖ **!gmail ** ==>**يعطيك حساب جيميل وهمي**
  ❖ **رابط ** ==>** يعطيك رابط السيرفر**
  ❖ **!emoji [hi]  ** ==>**ايموجي **
  ❖ **!bot list ** ==>** يعضر لك كم سيرفر دخل البوت**
