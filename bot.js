...
client.on('message', message => {
  ...
  **__!setmember__->** يسوي روم  فيه عدد العضاء
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!settime__->** يسوي روم فيه الوقت
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!setDate__->** يسوي روم فيه التاريخ
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!!v2min __->** يسوي روم مؤقت دقيقتين
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!bc__->**برود كاست 
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
client.on('message', message => {
     ...
     let embed = new Discord.RichEmbed()
.setColor("RANDOM")
.setTitle("Ｌｅｇａｎｄ Ｓｅｒｖｅｒ to invite TopMc Bot")
.setAuthor("Ｌｅｇａｎｄ Ｓｅｒｖｅｒ", "https://images-ext-2.discordapp.net/external/mE1tnTSH2_L-y_WW4QdhzzE-w0SS04Ft5pHAJHULQD4/https/cdn.discordapp.com/icons/503987674114162699/29b5e50bbb5fe1b1b295d7418675b93a.jpg")
.setTimestamp()
...
client.on('message', ( message ) => {
  ...
  if(message.channel.id !== '520884218004242453') return;
...
client.on('message', function(message) {
    if (message.channel.type === "dm") {
        ...
        client.channels.get("520889648822616104").send({ embed: stewart });
    }
});
...
client.on("message", message => {
     ...
     let user = message.mentions.users.first();
     let modlog = client.channels.find('name', 'chat-log');
...
setInterval(function(){
client.channels.find('id', '520892766226612226').setName("L");
client.channels.find('id', '520892766226612226').setName("LE");
client.channels.find('id', '520892766226612226').setName("LEG");
client.channels.find('id', '520892766226612226').setName("LEGA");
client.channels.find('id', '520892766226612226').setName("LEGAN");
client.channels.find('id', '520892766226612226').setName("LEGAND");
client.channels.find('id', '520892766226612226').setName("LEGAND-");
client.channels.find('id', '520892766226612226').setName("LEGAND-S");
client.channels.find('id', '520892766226612226').setName("LEGAND-SE");
client.channels.find('id', '520892766226612226').setName("LEGAND-SER");
client.channels.find('id', '520892766226612226').setName("LEGAND-SERV");
client.channels.find('id', '520892766226612226').setName("LEGAND-SERVE");
client.channels.find('id', '520892766226612226').setName("LEGAND-SERVER");
  }, 3000);
});
...
client.on("guildCreate", guild => {
    client.channels.get("520889648822616104").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
    
    client.on("guildDelete", guild => {
    client.channels.get("520889648822616104").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
